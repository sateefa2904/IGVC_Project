...
# - TM4C serial identical to your working arrow script (CR EOL, DTR/RTS=True, 10ms/byte)
# - Lidar uses standard iter_scans, fixed to your working baud (1,000,000)
...
# Behavior thresholds (mm) — unchanged
THRESH_MAIN        = 762
...
def open_motor(port, baud):
    ...
    # match the Windows arrow script behavior
    ser.dtr = True
    ser.rts = True
...
# ---------- Main ----------
def main():
    ap = argparse.ArgumentParser(description="RPLidar 3-angle avoidance -> TM4C (word protocol).")
